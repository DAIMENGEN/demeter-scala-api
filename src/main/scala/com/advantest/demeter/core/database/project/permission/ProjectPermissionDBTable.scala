 ...
 */
final case class ProjectPermissionDBTable()(implicit val db: Database) extends DBTable {
  override protected type TableRowData = ProjectPermissionDBTableRow
  override protected val table: TableQuery[ProjectPermissionDBTableSchema] = TableQuery[ProjectPermissionDBTableSchema]
